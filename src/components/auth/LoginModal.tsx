        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
                ...
                <p className="text-slate-600 mb-6">
                    {mode === 'signin'
                        ? 'Sign in to continue your essay analysis'
                        : 'Get started with 5 free credits per day'}
                </p>
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full border-2 border-slate-300 py-2.5 rounded-lg font-medium hover:bg-slate-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                >
                    {loading ? (
